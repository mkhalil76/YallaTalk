                                    ...
                                    <td>
                                       <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                          <div class="btn-group mr-2" role="group" aria-label="First group">
                                             <a href="{{ url('admin/payments/accept-transfer/'.$refund->id) }}"><button class="btn btn-success">Transfer</button></a>
                                          </div>
                                          <div class="btn-group mr-2" role="group" aria-label="Second group">
                                             <a href="{{ url('admin/payments/reject-refund/'.$refund->id.'/2') }}"><button class="btn btn-danger">Reject</button></a>
                                          </div>
                                       </div>
                                    </td>
                                    @else
